    ...
    <div class="containerBox">
        ...
        <form action="submitRegister.php" method="POST">
            <div class="contents">
                ...
                <div class="vehicle_details mt-4">
                    <h4>VEHICLE DETAILS</h4>
                    <div class="row">
                    <div class="col">
    <label for="unit">UNIT</label>
    <select id="unit" name="unit" onchange="changeUnitInput()">
        ...
        <option value="MULTICAB">MULTICAB</option>
                        ...
                        <div class="col">
                            ...
                            <input type="number" id="body_no" name="body_no">
                        </div>
                    </div>
                </div>
                <div class="submit_button d-flex justify-content-end mt-5">
